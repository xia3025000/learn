...
public class Leetcode376 {
    ...
    public List<Integer> wiggleMaxLength(int[] nums) {
    ...
    public List<Integer> wiggleMaxLength2(int[] nums) {
        List<Integer> res = new ArrayList<>();
        int n = nums.length;
        if (n == 0 || n == 1) {
            return res;
    ...
    public static void main(String[] args) {
        ...
        List<Integer> res1 = leetcode376.wiggleMaxLength(nums);
        List<Integer> res2 = leetcode376.wiggleMaxLength2(nums);
